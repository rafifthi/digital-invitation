...
export function AccountSettingsPanel({ account }: { account: AccountProfile }) {
  ...
  return (
    <section className="mx-auto max-w-[920px] space-y-5">
      <SectionHeading eyebrow="Account settings" title="Profile and access" />
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <CardDescription className="mt-1">
                Identity is read from server-side environment variables.
              </CardDescription>
            </div>
          ...
          <div className="flex min-h-16 items-center justify-between gap-4 rounded-xl border bg-[#fafafa] p-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Receive product and invitation activity summaries.
              </p>
            </div>
